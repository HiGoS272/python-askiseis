...
# Ενα laptop κωστιζει 490€, και ο πολιτης μας δινει εκπτωση 15%.  Σε μια συναρτηση να υπολογιστει και να επιστρεψει την εκπωση του προΪοντος.. ( egine )
# σε μια αλλη συναρτηση να επισταφει και τα υπολογιστει Το ΦΠΑ 13%. ( egine )
# και επιτα θα υπολογιστει και θα υπολογιζει τη καθαρη τιμη του laptop 22 % ( egine )
